        <div class="row">
            ...
            <div class="col-sm-9 content-box">
                ...
                <p>
                    <ol>
                        <li>スマートフォンやタブレットに保存し、オフラインで閲覧したい</li>
                        <li>Youtube上の動画が削除されたり、誤って自分で削除するためにバックアップを保存したい</li>
                        <li>削除される前に「魚拓」を取りたい</li>
                        <li>Youtube広告なしで動画を見たい</li>
                    </ol>
                </p>

                <p>その他、以下のような特徴があります。</p>
                <p>
                    <ol>
                        <li>mp4形式で保存</li>
                        <li>ダウンロードされた動画は、リンクを共有すればみんなで閲覧可能</li>
                        <li>ダウンロードできる動画の最大サイズは<strong>150MB</strong>まで</li>
                        <li>ダウンロードできる動画はyoutube.comから<strong>15秒</strong>以内でダウンロードできるもののみ</li>
                        <li><strong>(準備中)ログイン後は、最大サイズ、ダウンロード時間の限界を解除</strong></li>
                    </ol>
                </p>
